      ...
      {!searchParams.status && totalCount > 0 && (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4 space-y-3">
          ...
          <div className="h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden flex gap-px">
            ...
            {statusCounts.snag > 0 && <div className="h-full bg-rose-400 transition-all" style={{ width: `${Math.round((statusCounts.snag/totalCount)*100)}%` }} />}
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1.5 text-xs text-gray-500 dark:text-gray-400">
            ...
            {statusCounts.snag > 0 && <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-rose-400 inline-block" />Snag ({statusCounts.snag})</span>}
